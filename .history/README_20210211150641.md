...
I model sono nella directory  App\Http\Models. Per il model Subscriber è stato creato un validatore interno per il check dei dati dopo il parsing dell'xml. Sono tutti model 
