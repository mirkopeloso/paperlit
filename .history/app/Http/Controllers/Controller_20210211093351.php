        ...
        if ($request->file()) {
            ...
            foreach ($subscribers as $subscriber) {
                ...
                while ($subscriber->stop->diffInDays($startDay) > 0) {
                    ...
                    Log::debug('diff ' . $subscriber->stop->diffInDays($startDay, true));
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 365 > 0) {
                        Log::debug('entered in 365');
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 30 > 0) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 7 > 0) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 1 > 0) {
