        ...
        if ($request->file()) {
            ...
            foreach ($subscribers as $subscriber) {
                ...
                while ($subscriber->stop->diffInDays($startDay) > 0) {
                    ...
                    Log::debug('diff ' . $subscriber->stop->diffInDays($startDay)%365);
                    Log::debug('diff ' . $subscriber->stop->diffInDays($startDay)%30);
                    Log::debug('diff ' . $subscriber->stop->diffInDays($startDay)%7);
                    Log::debug('diff ' . $subscriber->stop->diffInDays($startDay)%1);
