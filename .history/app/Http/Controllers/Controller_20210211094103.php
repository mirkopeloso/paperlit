        ...
        if ($request->file()) {
            ...
            foreach ($subscribers as $subscriber) {
                ...
                while ($subscriber->stop->diffInDays($startDay) > 0) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 365 > 1) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 30 > 1) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 7 > 1) {
                    ...
                    if ($subscriber->stop->diffInDays($startDay, true) / 1 > 1) {
