        ...
        if ($request->file()) {
            ...
            foreach ($ss as $s) {
                ...
                if ($subscriber->validate($s)) {
                    ...
                    $subscriber->timestamp   = Carbon::createFromFormat('Ymd',$s['timestamp'])->format();
                    $subscriber->user        = $s['user'];
                    $subscriber->name        = $s['name'];
                    $subscriber->start       = Carbon::createFromFormat('Ymd',$s['start'])->format('Ymd');
                    $subscriber->stop        = Carbon::createFromFormat('Ymd',$s['stop'])->format('Ymd');
